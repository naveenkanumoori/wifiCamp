...
-(void)connectToLocationServer
{
    ...
    if (myError==nil)
    {
        ...
        NSRange match = [langID rangeOfString:@"-"];
         ...
         postData = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"7B0FDE8A-6101-48FD-93F6-924204000712",@"uuid",nil,@"vMDSPId",nil,@"minor",nil,@"deviceId",nil,@"major",[wifiInfo objectForKey:@"BSSID"],@"bssid",@"wifi entry",@"eventType",nil,@"latitude",nil,@"longitude", nil ];
       // NSLog(@"%@",postData);
        ...
        postHeader=[NSMutableDictionary dictionaryWithObjectsAndKeys:savedKey,@"Apikey",HmacValue,@"Hmac",md5Value,@"Content-MD5",random,@"nonce",langID,@"langId", nil ];
        
        NSURL *myURL = [NSURL URLWithString:@"http://96.119.2.154/ProximityEvents/proximityEventBeacon"];
                            ...
                            if ([[result objectForKey:@"entry"] caseInsensitiveCompare:@"ENTRY"]==NSOrderedSame)
                            {
                                ...
                                if (dataStored !=nil)
                                {
                                    ...
                                    if (dictinaryFromData!=nil && dictinaryFromData.count>0)
                                    {
                                        ...
                                        [self checkCampaignForwifi:newData];
                                        self.currentRequestToServer=nil;
                                    }
                                }
                            }
